...
**t515. 附魔台 UI（工作台蓝本重做）** — 现 EnchantingTableUI 是 shell-mode（选中槽操作），改成像工作台：上方附魔功能区（占位，功能后补）+ 底部背包 4 行（能放/取背包物品）。先做界面，功能后补。 ✅✅ 已完成（commit 5dee58f）
