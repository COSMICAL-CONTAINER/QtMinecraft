...
**t614** 附魔系统设计文档（dev-plan 内呈现，用户过目后才实现 t615）
- 写入本节下方「附魔系统设计（待过目）」：
