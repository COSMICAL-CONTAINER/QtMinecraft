...
**t567 指南针** ❌（4 铁锭+1 红石；指向出生点；出生点在第一个区块中心非全 0；动画留空白）
**t568 钟** ❌（金锭+红石；看当前时间；PNG 链接留 D 接口）
**t569 红石矿石** ❌（复制钻石矿图改红色；走过/挖掘发微弱红光）
**t570 月亮/星星** ❌（月亮背景灰 PNG 消不掉→改正方形月亮；星星太大比月亮大）
